...
plot_path(path_geopressureviz)
saveRDS(object = path_geopressureviz, file = paste0('./data/interim/', id, '_path_geopressreviz.rds'))
```
...
plot(tag,
  type = "twilight",
    twilight_line = path2twilight(path_geopressureviz),
...
save.image(file = paste0('./data/interim/', id, '.RData'))
